...
namespace InTheClearWebV2.Services
{
    public class DirectionsService : IDirectionsService
    {
        ...
        public DirectionsService(IConfiguration _configuration)
        {
        ...
        {
            var key = configuration.GetValue<string>("GoogleMaps:Key");
        ...
        {
            var appId = configuration.GetValue<string>("Here:App_Id");
            var appCode = configuration.GetValue<string>("Here:App_Code");
        ...
        {
            var key = configuration.GetValue<string>("AWS:Key");
